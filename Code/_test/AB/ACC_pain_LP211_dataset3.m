...
% results.HPS.ID_sig_ch = cell(2,2); % Significant changing selectivity before/after treatment in HPS
% results.HPS.ID_sig_st = cell(2,2); % Significant stable selectivity before/after treatment in HPS
% results.HPS.ID_sig = cell(2,2); % Significant selective cells in HPS
% results.HPS.ID_sig_post = cell(2,2); % Significant selective cells in HPS
...
%         for i = 1:size(results.HPS.DATA_p{a,b},1)
%             if results.HPS.DATA{a,b}(i,8) == 0 && results.HPS.DATA{a,b}(i,9) == 0 % Always non modulated
%                 results.HPS.DATA_sig_ch{a,b}(i,10) = 0;
% %                 results.HPS.ID_sig_ch{a,b}(i,1) = 0;
%             elseif results.HPS.DATA{a,b}(i,8) > 0 && results.HPS.DATA{a,b}(i,9) > 0 % Always modulated
%                 results.HPS.DATA_sig_ch{a,b}(i,10) = 0;
% %                 results.HPS.ID_sig_ch{a,b}(i,1) = 0;
%             else
%                 results.HPS.DATA_sig_ch{a,b}(i,10) = 1;
% %                 results.HPS.ID_sig_ch{a,b}(i,1) = 1;
%             end
%         end
%         results.HPS.DATA_sig_ch{a,b} = results.HPS.DATA_sig_ch{a,b}(any(results.HPS.DATA_sig_ch{a,b}(:,10),10),:); % Remove rows with zeros in the index column
%         results.HPS.DATA_sig_ch{a,b}(:,10) = []; % Remove index column
%     end
% end
% 
...
%         for i = 1:size(results.HPS.DATA_p{a,b},1)
%             if results.HPS.DATA{a,b}(i,8) == 0 && results.HPS.DATA{a,b}(i,9) == 0 % Always non modulated
%                 results.HPS.DATA_sig_st{a,b}(i,10) = 1;
% %                 results.HPS.ID_sig_st{a,b}(i,1) = 1;
%             elseif results.HPS.DATA{a,b}(i,8) > 0 && results.HPS.DATA{a,b}(i,9) > 0 % Always modulated
%                 results.HPS.DATA_sig_st{a,b}(i,10) = 1;
% %                 results.HPS.ID_sig_st{a,b}(i,1) = 1;
%             else
%                 results.HPS.DATA_sig_st{a,b}(i,10) = 0;
% %                 results.HPS.ID_sig_st{a,b}(i,1) = 0;
%             end
%         end
%         results.HPS.DATA_sig_st{a,b} = results.HPS.DATA_sig_st{a,b}(any(results.HPS.DATA_sig_st{a,b}(:,10),10),:); % Remove rows with zeros in the index column
%         results.HPS.DATA_sig_st{a,b}(:,10) = []; % Remove index column
%     end
% end
% 
...
%         for i = 1:size(results.HPS.DATA_p{a,b},1)
%             if results.HPS.DATA{a,b}(i,8) == 0 && results.HPS.DATA{a,b}(i,9) > 0 % Always non modulated
%                 results.HPS.DATA_sig_post{a,b}(i,10) = 1;
% %                 results.HPS.ID_sig_post{a,b}(i,1) = 1;
%             else
%                 results.HPS.DATA_sig_post{a,b}(i,10) = 0;
% %                 results.HPS.ID_sig_post{a,b}(i,1) = 0;
%             end
%         end
%         results.HPS.DATA_sig_post{a,b} = results.HPS.DATA_sig_post{a,b}(any(results.HPS.DATA_sig_post{a,b}(:,10),10),:); % Remove rows with zeros in the index column
%         results.HPS.DATA_sig_post{a,b}(:,10) = []; % Remove index column
%     end
% end
...
for i = 1:2
    for ii = 1:2
        a = results.SP.DATA{i,ii}(:,4) - results.SP.DATA{i,ii}(:,3);
