...
# For test ####################################################################
# file_input = "D:\\_MATLAB_2PI\\frequency.csv"
# file_output = "D:\\_MATLAB_2PI\\test.pdf"
# data_type = "amplitude"
# data_limits = '"0.00127, 0.00447"'
# verbose = TRUE
###############################################################################
...
data.long <- tidyr::gather(data = data.wide, key = "day", value = "value", Session_1, Session_2)#, day_2, day_1_post, day_2_post)
