...
from decoding.third_party.matplotlib_venn._math import *
from decoding.third_party.matplotlib_venn._common import *
from decoding.third_party.matplotlib_venn._region import VennCircleRegion, VennEmptyRegion
...
def venn3(subsets, set_labels=('A', 'B', 'C'), set_colors=('r', 'g', 'b'), alpha=0.4, normalize_to=1.0, ax=None, subset_label_formatter=None):
    ...
    The subsets parameter can be one of the following:
     ...
     - A dictionary, providing sizes of seven diagram regions.
