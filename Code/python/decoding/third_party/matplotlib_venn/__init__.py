...
Example::
    ...
    plt.annotate('Unknown set', xy=v.get_text_by_id('100').get_position() - np.array([0, 0.05]), xytext=(-70,-70),
                ha='center', textcoords='offset points', bbox=dictionary(boxstyle='round,pad=0.5', fc='gray', alpha=0.1),
                arrowprops=dictionary(arrowstyle='->', connectionstyle='arc3,rad=0.5',color='gray'))
'''
from decoding.third_party.matplotlib_venn._venn2 import venn2, venn2_circles
from decoding.third_party.matplotlib_venn._venn3 import venn3, venn3_circles
from decoding.third_party.matplotlib_venn._util import venn2_unweighted, venn3_unweighted
