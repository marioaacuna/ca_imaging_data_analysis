...
def draw_alluvial_plot(data, timepoint_names, delete_hidden=True, group_names=None,
                       ...
                       label_offset=0.05, title=None, title_font=20, label_font=25, groups_font=25, output_filename='',
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        info_filename = r'D:\_MATLAB_CaImaging\alluvial_plot_data.mat'
    ...
    for time_step in range(n_time_points):
        ...
        fig = draw_alluvial_plot(data, timepoint_names=timepoint_names, delete_hidden=delete_hidden, group_names=group_names,
                                 ...
                                 label_offset=0.05, title=title, title_font=20, label_font=35, groups_font=28,
                                 output_filename='',
