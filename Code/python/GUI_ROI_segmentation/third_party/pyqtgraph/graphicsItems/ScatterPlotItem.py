...
def renderSymbol(symbol, size, pen, brush, device=None):
    ...
    Symbol may be either a QPainterPath or one of the keys in the Symbols dictionary.
    ...
    **Signals:**
    ...
    def setData(self, *args, **kargs):
        ...
        * If there are two unnamed arguments, they will be interpreted as sequences of x and y values.
        ...
        ====================== ===============================================================================================
        **Keyword Arguments:**
        *spots*                Optional list of dicts. Each dictionary specifies parameters for a single spot:
