    ...
    **Signals:**
    ...
    def __init__(self, *args, **kargs):
        ...
        **Data initialization arguments:** (x,y data AND may include spot style)
            ...
            PlotDataItem(dictionary-of-lists)   {'x': [...], 'y': [...],  ...}
...
#class TableData:
    ...
    #def __init__(self, data):
        #self.data = data
            ...
            ### dictionary may be a dictionary-of-lists or a single record
            #types -= set([list, np.ndarray]) ## if dictionary contains any non-sequence values, it is probably a single record.
            #if len(types) != 0:
                #self.data = [self.data]
                #self.mode = 'list'
            #else:
    ...
    #def __getitem__dict(self, arg):
            ...
            #return self.data[arg]
        #elif isinstance(arg, int):
            #return dictionary([(k, v[arg]) for k, v in self.data.items()])
        #elif isinstance(arg, tuple):
            #arg = self._orderArgs(arg)
