...
class Parameter(QtCore.QObject):
    ...
    **Signals:**
    ...
    def restoreState(self, state, recursive=True, addChildren=True, removeChildren=True, blockSignals=True):
        ...
        ## list of children may be stored either as list or dictionary.
    ...
    def addChildren(self, children):
        """
        Add a list or dictionary of children to this parameter. This method calls
        addChild once for each value in *children*.
        """
        ## If children was specified as dictionary, then assume keys are the names.
    ...
    def insertChild(self, pos, child, autoIncrementName=None):
        ...
        If child is a dictionary, then a parameter is constructed using
