...
class ComboBox(QtGui.QComboBox):
    ...
    * Handles dictionary mappings -- user selects a text key, and the ComboBox indicates
      the selected value.
    ...
    * setItems() replaces the items in the ComboBox and blocks signals if the
    ...
    def value(self):
        ...
        selected text. If items were given as a dictionary, then return the value
    ...
    def setItems(self, items):
        """
        *items* may be a list, a tuple, or a dictionary.
        If a dictionary is given, then the keys are used to populate the combo box
    ...
    def addItems(self, items):
        if isinstance(items, list) or isinstance(items, tuple):
            ...
            raise TypeError("items argument must be list or dictionary or tuple (got %s)." % type(items))
