...
class DataFilterParameter(ptree.types.GroupParameter):
    ...
    def setFields(self, fields):
        ...
        *fields* must be a dictionary or list of tuples that maps field names
        to a specification describing the field. Each specification is
        itself a dictionary with either ``'mode':'range'`` or ``'mode':'enum'``::
...
class RangeFilterItem(ptree.types.SimpleParameter):
    def __init__(self, name, opts):
        ...
        ptree.types.SimpleParameter.__init__(self, 
            ...
            children=[
                #dictionary(name="Field", type='list', value=name, values=fields),
