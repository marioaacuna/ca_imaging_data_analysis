...
class Flowchart(Node):
    ...
    def output(self):
        """Return a dictionary of the values on the Flowchart's output terminals.
        """
    ...
    def process(self, **args):
        ...
        The return value is a dictionary with one key per output terminal.
        ...
        for c, arg in order:
            ...
            if c == 'p':     ## Process a single node
                ...
                for inp in ins:
                    ...
                    if len(inputs) == 0:
                        continue
                    if inp.isMultiValue():  ## multi-input terminals require a dictionary of all inputs
