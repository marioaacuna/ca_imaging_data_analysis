...
class Node(QtCore.QObject):
    ...
    2) a process() function which takes the names of input terminals as keyword arguments and returns a dictionary with the names of output terminals as keys.
    ...
    def inputs(self):
        """Return dictionary of all input terminals.
        Warning: do not modify."""
        return self._inputs

    def outputs(self):
        """Return dictionary of all output terminals.
        Warning: do not modify."""
    ...
    def process(self, **kargs):
        ...
        corresponding to each input terminal, and must return a dictionary mapping the name
    ...
    def inputValues(self):
        """Return a dictionary of all input values currently assigned to this node."""
        vals = {}
    ...
    def outputValues(self):
        """Return a dictionary of all output values currently generated by this node."""
        vals = {}
