...
from Utilities import idx2range, rotate, segment_epm_maze
...
################################################
save_csv_path = "C:/Users/acuna/Desktop/fun_python/epm_data/epm_data" + str(date_exp)+ "_"+str(animal_id)+".csv"
...
if save_figures_option == 'yes':
    save_pdf_path = (
                "C:/Users/acuna/Desktop/fun_python/epm_data/figures/epm_figures" + str(
            date_exp) + "_" + str(animal_id) + ".pdf")
...
fig = plt.figure()
plt.pie(time_spent_in_arms, labels=['open', 'closed', 'center'], autopct='%1.1f%%',  colors= ['r','g', 'b'])
...
save_csv_metadata_path = "C:/Users/acuna/Desktop/fun_python/epm_data/epm_data_" + str(date_exp)+ "_"+str(animal_id)+"_metadata.csv"
