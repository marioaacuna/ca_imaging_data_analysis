...
list.of.packages <- c("ggplot2", "ggbeeswarm", "tidyr", "optparse", "grid", "tibble", "plyr", "entropy", "MASS")
...
data = as.matrix(DATA)
disc_data = discretize(data, numBins = 5)
View(disc_data)
...
freqs_data = freqs(data) 
E_Shrink = entropy(data, freqs_data, method = "shrink", verbose = FALSE)
